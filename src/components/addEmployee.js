...
function AddEmployee(props) {
  ...
  return (
    <>
        <button onClick={handleShow} className="block m-2 mx-auto bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded">+ Add Employee</button>
      ...
      >
        ...
        <form onSubmit={(p) => {
          ...
          props.newEmployee(name, role, img)
            ...
            <div className="md:flex md:items-center mb-6">
                ...
                }} placeholder="https://google.com/pic.png"/>
                </div>
            </div>
        ...
        <Modal.Footer>
          ...
          <button onClick={handleClose} className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-2 px-4 rounded" form="editmodal">Add</button>
        </Modal.Footer>
      </Modal>
    </>
  );
